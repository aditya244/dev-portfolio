...
export default function Contact() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-800 md:pt-16 md:pb-16 ">
            <div className="bg-white border-slate-700 border-2 shadow-sm m-4 md:m-16 text-center p-4
                    md:pt-16 md:pb-16 shadow-inner rounded-md">
                <div className='grid grid-rows-1 md:grid-cols-2 mt-4 justify-items-center md:mr-6'>
                    ...
                    <input className="rounded-sm mt-2 md:ml-8 bg-slate-200 shadow-inner" type="text"/>
                </div>
                <div className='grid grid-rows-1 md:grid-cols-2 mt-4 justify-items-center md:mr-6'>
                ...
                <div className='grid grid-rows-1 md:mt-6 justify-items-center mt-2'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 bg-white gap-4 p-4 md:p-6 border-slate-700 border-2 
                shadow-sm m-4 md:m-16 text-center pb-4 mb-8 md:pt-16 md:pb-16 shadow-inner rounded-md">
                <div className="bg-white border-slate-900 border-0 shadow-md shadow-slate-300">
                    <img src={GithubLogo} height="90" width="90" />
                    <p className='text-sm font-serif p-2 md:pt-6 antialiased text-justify p-4'> Check my work on Github. There are various projects based on different
